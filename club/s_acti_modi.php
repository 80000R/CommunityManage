...
<?php
  ...
  $records = $d->query('SELECT actName,actTime,actPlace,actContent,resStuName,resContact FROM Activity WHERE actID = ? AND comNumber = ?',array($anum,$cnum));
  $rows = 0;
  $temp = array();
...
<div class="container" style="margin-top:30px">
  <div class="row">
    ...
    <div class="col-sm-8">
      ...
      <form method="post" action="s_acti_modi_deal.php">
        <div class="input-group mb-3">
          <div class="input-group-prepend">
            <span class="input-group-text">时间</span>
          </div>
          <input type="text" class="form-control" id="stime" name="stime" value="">
